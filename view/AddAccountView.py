...
class AddAccountView(tk.Toplevel):
    ...
    def __setup_widgets(self):
        ...
        self.cancel_button = tk.Button(self, text='Cancel', command=self.destroy, font=FONTSIZE_LABEL)
        self.cancel_button.pack(side=tk.BOTTOM, fill=tk.BOTH)
        self.submit_button = tk.Button(self, text='Add Account', command=self.submit_account, font=FONTSIZE_LABEL)
